...
O CLI nao usa chamadas de IA, rede ou telemetria. Apenas consulta `claude --version`
com timeout durante o diagnostico. Nao presume que os arquivos representem flags
...
Nao rotule o pacote como plugin oficial da Anthropic. Marketplace/plugin e uma
evolucao opcional futura; esta versao distribui uma skill standalone.
